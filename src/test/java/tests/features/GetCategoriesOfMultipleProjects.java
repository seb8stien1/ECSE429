...
public class GetCategoriesOfMultipleProjects {
    ...
    public void theCategoriesAndAssociatedWithShouldBeReturned(String categoryTitle1, String categoryTitle2, String projectTitle) {
        // todo
    }
    ...
    public void onlyTheCategoryAssociatedWithTheProjectShouldBeReturned(String categoryTitle, String projectTitle) {
        // todo
    }
